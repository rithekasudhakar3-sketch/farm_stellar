    ...
    <div className="space-y-4">
      {milestones.map((milestone, idx) => {
        ...
        return (
          <div
            key={idx}
            className={`relative rounded-2xl p-5 border-2 transition-all ${isUnlocked && !isClaimed
          ...
          >
            ...
            <div className="flex items-center gap-4">
              {/* Icon */}
              <div
                className={`p-4 rounded-2xl flex-shrink-0 ${isUnlocked && !isClaimed ? "bg-gradient-to-br from-accent to-primary animate-bounce" : "bg-muted/50"
                  }`}
              >
              ...
              <div className="flex-1 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-bold text-accent flex items-center gap-1">
                      ...
                      {milestone.requiredXP} {t("common.xp")}
                    </p>
                  </div>
                </div>
                ...
                {isClaimed && (
                  <div className="text-center py-2">
                    <p className="text-xs text-muted-foreground">✓ {t("rewards.claimed")}</p>
                  </div>
                )}
              </div>
            </div>
