    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-primary to-secondary px-6 py-6 text-primary-foreground border-b border-border/20 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold mb-1">{t("dashboard.adminDashboard")}</h2>
            <p className="text-sm opacity-90">{t("dashboard.manageFarmers")}</p>
          </div>
          <button
      ...
      <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          >
            ...
            <p className="font-bold text-foreground">{t("dashboard.manageFarmers")}</p>
            <p className="text-xs text-muted-foreground mt-1">{t("dashboard.viewProfiles")}</p>
          </button>
          ...
          >
            ...
            <p className="font-bold text-foreground">{t("dashboard.manageQuests")}</p>
            <p className="text-xs text-muted-foreground mt-1">{t("dashboard.createContent")}</p>
          </button>
          ...
          >
            ...
            <p className="font-bold text-foreground">{t("dashboard.verifyActivities")}</p>
            <p className="text-xs text-muted-foreground mt-1">{t("dashboard.reviewSubmissions")}</p>
          </button>
          ...
          >
            <Target className="w-8 h-8 text-accent mb-3" />
            <p className="font-bold text-foreground">{t("dashboard.manageRewards")}</p>
            <p className="text-xs text-muted-foreground mt-1">{t("dashboard.adjustRewards")}</p>
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-card rounded-2xl p-6 border border-border shadow-sm">
            ...
            <p className="text-sm text-muted-foreground mt-1">{t("dashboard.totalFarmers")}</p>
          </div>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border shadow-sm">
            ...
            <p className="text-sm text-muted-foreground mt-1">{t("dashboard.newSignups")}</p>
          </div>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border shadow-sm">
            ...
            <p className="text-sm text-muted-foreground mt-1">{t("dashboard.activeUsers")}</p>
          </div>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border shadow-sm">
            ...
            <p className="text-sm text-muted-foreground mt-1">{t("dashboard.questsCompleted")}</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
          <div className="p-6 border-b border-border">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-foreground text-lg">{t("dashboard.registeredFarmers")}</h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-muted/50">
                <tr>
                  <th className="text-left text-xs font-medium text-muted-foreground uppercase p-4">{t("common.name")}</th>
                  <th className="text-left text-xs font-medium text-muted-foreground uppercase p-4">{t("common.level")}</th>
                  <th className="text-left text-xs font-medium text-muted-foreground uppercase p-4">{t("common.location")}</th>
                  <th className="text-left text-xs font-medium text-muted-foreground uppercase p-4">{t("common.xp")}</th>
                  <th className="text-left text-xs font-medium text-muted-foreground uppercase p-4">{t("common.quests")}</th>
                  <th className="text-left text-xs font-medium text-muted-foreground uppercase p-4">{t("common.actions")}</th>
                </tr>
              </thead>
                ...
                {loading ? (
                  <tr>
                    <td colSpan="6" className="p-8 text-center text-muted-foreground">
                      {t("dashboard.loadingFarmers")}
                    </td>
                  </tr>
                ) : filteredFarmers.length === 0 ? (
                  <tr>
                    <td colSpan="6" className="p-8 text-center text-muted-foreground">
                      {t("dashboard.noFarmersFound")}
                    </td>
                  </tr>
                ) : (
                    ...
                    <tr key={farmer._id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="p-4">
                        <span className="inline-block text-xs bg-accent/20 text-primary px-2 py-1 rounded-full font-medium">
                          {farmer.level || t("common.beginner")}
                        </span>
                      </td>
                      <td className="p-4">
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-6 z-50">
          <div className="bg-card rounded-2xl border border-border shadow-xl max-w-2xl w-full max-h-[90vh] overflow-auto">
            <div className="sticky top-0 bg-card border-b border-border p-6 flex items-center justify-between">
              <h3 className="font-bold text-foreground text-xl">{t("dashboard.farmerDetails")}</h3>
              <button
            ...
            <div className="p-6 space-y-6">
              {/* Basic Info */}
              <div>
                <h4 className="font-bold text-foreground mb-3">{t("dashboard.basicInfo")}</h4>
                <div className="bg-muted/50 rounded-xl p-4 space-y-2">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">{t("dashboard.experienceLevel")}</span>
                    <span className="text-sm font-medium text-foreground">{selectedFarmer.level || t("common.beginner")}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              {/* Farm Details */}
              <div>
                <h4 className="font-bold text-foreground mb-3">{t("dashboard.farmDetails")}</h4>
                <div className="bg-muted/50 rounded-xl p-4 space-y-2">
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">{t("dashboard.farmName")}</span>
                    <span className="text-sm font-medium text-foreground">{selectedFarmer.farm?.name || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">{t("dashboard.joinedDate")}</span>
              ...
              {/* Quest Progress */}
              <div>
                <h4 className="font-bold text-foreground mb-3">{t("dashboard.questProgress")}</h4>
                <div className="bg-gradient-to-br from-accent/10 to-primary/5 rounded-xl p-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">{t("dashboard.questsCompleted")}</p>
                    </div>
                    <div className="text-center">
                      <p className="text-3xl font-bold text-accent">{selectedFarmer.xp || 0}</p>
                      <p className="text-xs text-muted-foreground mt-1">{t("dashboard.totalXP")}</p>
                    </div>
                  </div>
                </div>
              </div>
